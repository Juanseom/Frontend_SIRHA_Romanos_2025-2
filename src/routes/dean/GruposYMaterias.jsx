...
const GruposYMaterias = () => {
  ...
  const [materias] = useState([
    ...
    },
    {
      id: 9,
      codigo: "ODSC",
      nombre: "Organización de Sistemas Computacionales",
      creditos: 3,
      programa: "Ingeniería de Sistemas",
      departamento: "Sistemas",
      estado: "activa"
  ...
  const [todosLosGrupos, setTodosLosGrupos] = useState([
    {
      ...
      materiaCodigo: "EGI3",
      clase: 'EGI3',
      seccion: 'LEC ORDINARIA',
      nombreCompleto: "Inglés III-1",
      codigoGrupo: "1234",
      diasHoras: 'LUN-MIE-VIER 14:00-16:00',
      aula: 'D-309',
      instructor: 'ANDRÉS MARTÍN CANTOR',
      color: 'verde',
      ciclo: '2025-2',
      estado: 'abierto',
      cuposOcupados: 25,
    ...
    },
    {
      ...
      clase: 'MBDA',
      seccion: 'LEC ORDINARIA',
      nombreCompleto: "Modelos de Bases de Datos-2",
      codigoGrupo: "1235",
    ...
    },
    {
      ...
      clase: 'FPOP',
      seccion: 'LEC ORDINARIA',
      nombreCompleto: "Filosofía y Cultura Popular-1",
      codigoGrupo: "2345",
    ...
    },
    {
      ...
      clase: 'PSOC',
      seccion: 'LEC ORDINARIA',
      nombreCompleto: "Psicología Social-1",
      codigoGrupo: "3456",
    ...
    },
    {
      ...
      clase: 'DOSW',
      seccion: 'LEC ORDINARIA',
      nombreCompleto: "Desarrollo y Operaciones de Software-2",
      codigoGrupo: "4567",
    ...
    },
    {
      ...
      clase: 'PRYE',
      seccion: 'LEC ORDINARIA',
      nombreCompleto: "Probabilidad y Estadística-1",
      codigoGrupo: "5678",
    ...
    },
    {
      ...
      clase: 'AYSR',
      seccion: 'LEC ORDINARIA',
      nombreCompleto: "Arquitectura y Sistemas en Red",
      codigoGrupo: "6789",
    ...
    },
    {
      ...
      clase: 'ODSC',
      seccion: 'LEC ORDINARIA',
      nombreCompleto: "Organización de Sistemas Computacionales-2",
      codigoGrupo: "7890",
    ...
    },
    {
      ...
      clase: 'DOSW',
      seccion: 'LEC ORDINARIA',
      nombreCompleto: "Desarrollo y Operaciones de Software-3",
      codigoGrupo: "8901",
    ...
    },
    {
      ...
      clase: 'PSOC',
      seccion: 'LEC ORDINARIA',
      nombreCompleto: "Psicología Social-2",
      codigoGrupo: "9012",
